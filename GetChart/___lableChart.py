...
print("Test For Labels Chart")


# Set Varibles
#------------------------------------------------
tickerName = 'SMFL'     
filePathExcel = r"C:\Users\lenovo\Desktop\TGL\Session [20240326_105900]\SMFL\OK SMFL.xlsx"                                                               #r"D:\Python Tools\ChartMaker\SourceDocuments\OutPut_Excel\Session [20230921_221745]\NVDA\OK NVDA.xlsx"
...
def test ():
    ...
    #             #Make Time Lable
    #             timeLable = TimeLableXaxis.fTimeLable  (source="IBKR"   ,interval=indexScope   ,inList=list (df.index.map(str)))
